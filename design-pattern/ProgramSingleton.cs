...
namespace SingletonDemo
{
    class ProgramSingleton
    {
        ...
        {
            var config = ConfigurationManagerSingletonExample.Instance;
            Console.WriteLine(config.GetSetting("AppTitle"));  // Output: My Application
            Console.WriteLine(config.GetSetting("Version"));   // Output: 1.0.0
